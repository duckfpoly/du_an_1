...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/css_site/flaticon.css">
    <link rel="stylesheet" href="./assets/css/css_site/progressbar_barfiller.css">
    <link rel="stylesheet" href="./assets/css/css_site/gijgo.css">
    <link rel="stylesheet" href="./assets/css/css_site/animate.min.css">
    <link rel="stylesheet" href="./assets/css/css_site/animated-headline.css">
    <link rel="stylesheet" href="./assets/css/css_site/magnific-popup.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css" integrity="sha512-xh6O/CkQoPOWDdYTDqeRdPCVd1SpvCA9XXcUnZS2FmJNp1coAFzvtCN9BmamE+4aHK8yyUHUSCcJHgXloTyT2A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="./assets/css/css_site/themify-icons.css">
    <link rel="stylesheet" href="./assets/css/css_site/slick.css">
    <link rel="stylesheet" href="./assets/css/css_site/nice-select.css">
    <link rel="stylesheet" href="./assets/css/css_site/style.css">
</head>
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/img_site/img/logo/loder.png" alt="">
                </div>
            </div>
        </div>
    </div>
