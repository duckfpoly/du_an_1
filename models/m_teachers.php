<?php
    function check_image_teacher($image_teacher){
        ...
        $check_image_teacher = (new process())->query_one($sql, $image_teacher);
    ...
    function check_phone_teacher($phone_teacher){
        ...
        $check_phone_teacher = (new process())->query_one($sql, $phone_teacher);
    ...
    function teachers_create($name_teacher,$email_teacher,$phone_teacher, $password_teacher,$image_teacher,$about_teacher,$scope_teacher,$created_at){
        ...
        $sql = "INSERT INTO `teachers` SET 
                ...
                `created_at`            =   ?
        ";
        (new process())->query_sql($sql,$name_teacher,$email_teacher,$phone_teacher,$password_teacher_hash,$image_teacher,$about_teacher,$scope_teacher,$created_at);
    }
