                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="row px-xl-5 px-sm-4 px-3">
                            <div style="margin: 0px auto;" class="col-3 me-auto px-1">
                        ...
                        <div class="card-body">
                            <form role="form" method="post" action="<?= BASE_URL ?>login" id="form-1">
                                ...
                                <?php if(isset($login)){
                                    echo '<div class="alert alert-danger text-light mb-2 mt-3 fw-bold text-center"><small>'.$login.'</small></div>';
                                } ?>
                                <?php if(isset($ad_login)){
                                    echo '<div class="alert alert-danger text-light mb-2 mt-3 fw-bold text-center"><small>'.$ad_login.'</small></div>';
                                } ?>
