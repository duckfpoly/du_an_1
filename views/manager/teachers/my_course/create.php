                                ...
                                <div class="col-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2 d-flex justify-content-around flex-wrap">
                                            ...
                                            <div class="p-3 col-8 ">
                                                <form action="<?= COURSE_TEACHER ?>/store" method="post" id="form-1" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group ">
                                                        <input type="hidden" name="id_teacher" id="id_teacher" class="form-control" value="<?= $id_teacher ?>">
                                                    </div>
                                                    <div class="mt-5">
