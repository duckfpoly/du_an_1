                                ...
                                <div class="col-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2 d-flex justify-content-around flex-wrap">
                                            ...
                                            <div class="p-3 col-8">
                                                <form action="<?= COURSE_TEACHER ?>/edit/<?= $courses_update['id'] ?>" method="post" id="form-1" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="form-group">
                                                                <input class="" type="radio" name="status_course" id="statusCourse1" value="0" <?= $courses_update['status_course'] == 0 ? "checked" : "" ?>>
                                                            ...
                                                            &emsp;&emsp;
                                                            <div class="form-group">
                                                                <input class="" type="radio" name="status_course" id="statusCourse2" value="1" <?= $courses_update['status_course'] == 1 ? "checked" : "" ?>>
                                                    ...
                                                    <div class="mt-5">
                                                        <a href="<?= COURSE_TEACHER ?>" class="btn btn-secondary">Quay lại</a>
