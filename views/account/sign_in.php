        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              <div class="col-3 me-auto px-1"  style="margin: 0px auto">
            ...
            <div class="card-body">
              <form role="form" method="post" action="<?= SIGIN?>" id="form-1">
                ...
                <div class="mb-3 form-group d-flex justify-content-end">
                  <p class="text-sm mt-3 mb-0"><a href="<?= BASE_URL ?>account/forgot_pass" class="text-dark font-weight-bolder">Quên mật khẩu?</a></p>
                </div>
